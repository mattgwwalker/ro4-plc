...
MEM &T0acc = 0 
MEM &AUX14_TEXT = "T0 s"
MEM &DISPLAY_FORMAT_AUX14 = 6 //x=0 x.x=6 x.xx=5 x.xxx=4

//Rig 2 Only
REG &FT12 = &AUX15
MEM &FT12 = 0
MEM &AUX15_TEXT = "FT12 l/h"
MEM &DISPLAY_FORMAT_AUX15 = 0 //x
...
MEM &TT01SP03 = 3500 //35.00degC Max Temp

//******************************************************
REG &LT02SP01 = &USER_MEMORY_157
MEM &LT02SP01 = 500 //5.00% Min Start Level

REG &LT02SP02 = &USER_MEMORY_158
 ...
 SELECT &displayState 
  CASE  0: //Display
   ...
   ELSE
    ...
    &DATA_SOURCE_DISPLAY2 = ADDR(&T0acc)
  ...
  CASE  6: //Display
   IF (&RoRigNumber = 2) THEN
    &DATA_SOURCE_DISPLAY1 = ADDR(&FT12) //...rig2
  ...
  CASE  15: //Display
   IF (&RoRigNumber = 2) THEN
    &DATA_SOURCE_DISPLAY1 = ADDR(&PT02)
    &DATA_SOURCE_DISPLAY2 = ADDR(&PT05) //...rig2
   ELSE
